...
X_train,X_test,Y_train,Y_test = train_test_split(
    X,
    Y,
    test_size= 0.5 , # nahi dyaycha karan ki tithe alraedy 08 yeil
...
#20 वेळा class 1 ला बरोबर ओळखले (True Positive)

#3 वेळा class 1 ला class 2 म्हणून predict केले (False Negative)

#0 वेळा class 1 ला class 0 म्हणून predict केले

#[0 4 19]

#19 वेळा class 2 ला बरोबर ओळखले (True Positive)

#4 वेळा class 2 ला class 1 म्हणून predict केले (False Negative)

#0 वेळा class 2 ला class 0 म्हणून predict केले
#
