...
np.set_printoptions(precision=3, suppress=True)  # precision = 3 means show at most 3 digits after decimal point when printing
#Supress = True means do not use scientific notation for smll numbers
print("=" * 70)
